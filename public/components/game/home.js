...
export default function Home(back,level) {
    ...
    this.back = createElement(back,{tagName:"div",className:"home",style:`width:${((innerWidth-(yLength*((innerWidth/100)*1.5)))/yLength)}px;height:${((innerWidth-(yLength*((innerWidth/100)*1.5)))/yLength)}px;border-radius: ${innerWidth/(yLength*8)}px;margin: 0px 0 ${innerWidth/(yLength*(15))}px ${innerWidth/(yLength*(15))}px`});
}
